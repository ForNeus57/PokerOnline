...
#ifndef POKER_ONLINE_COMMON_TESTING_FILE_GENERATOR_H
#define POKER_ONLINE_COMMON_TESTING_FILE_GENERATOR_H
...
#endif	//	POKER_ONLINE_COMMON_TESTING_FILE_GENERATOR_H
